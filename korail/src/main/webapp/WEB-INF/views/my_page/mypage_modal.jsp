					...
					<div class="border-box box_withdrawal">
						<div class="inner">
							<div class="box_inputForm">
								<strong>비밀번호</strong> <span class="box_label"><input type="password" name="usrPw" id="usrPw" class="input" placeholder=" 현재 사이트에 등록된 비밀번호를 입력하세요."> </span><span id="cmsg7"></span>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="inner">
							<div class="box_inputForm" id="pwdDiv">
								...
								<span class="box_label">
									<input type="password" name="usrPw1" id="usrPw1" class="input" placeholder=" 현재 비밀번호를 입력하세요">
								</span>
								<span id="cmsg4"></span>
							</div>
							<div class="box_inputForm" id="npwdDiv">
								...
								<span class="box_label">
									<input type="password" name="usrPw2" id="usrPw2" class="input" placeholder=" 영문, 숫자 8자리 이상"> 
								</span>
								<span id="cmsg5"></span>
							</div>
							<div class="box_inputForm" id="nnpwdDiv">
								<strong>새 비밀번호 확인</strong> <span class="box_label">
									<input type="password" name="usrPw3" id="usrPw3" class="input" placeholder=" 새 비밀번호를 재입력하세요"> 
								</span>
								<span id="cmsg6"></span>
							</div>
							<span id="cmsg"></span>
