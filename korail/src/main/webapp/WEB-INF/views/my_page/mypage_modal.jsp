					...
					<div class="border-box box_withdrawal">
						<div class="inner">
							<div class="box_inputForm">
								<strong>비밀번호</strong> <span class="box_label"><input type="password" name="usrPw" id="usrPw" class="input" placeholder=" 현재 사이트에 등록된 비밀번호를 입력하세요."> </span>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="pass_modal_cotents">
			<form name="passForm" method="post" action ="mypage_proc.do">
					...
					<div class="border-box box_withdrawal">
						<div class="inner">
							<div class="box_inputForm" id="pwdDiv">
								<strong>현재 비밀번호</strong> <span class="box_label"><input type="password" name="usrPw1" id="usrPw1" class="input" placeholder=" 현재 비밀번호를 입력하세요"> </span>
							</div>
							<div class="box_inputForm" id="npwdDiv">
								<strong>새 비밀번호</strong> <span class="box_label"><input type="password" name="usrPw2" id="usrPw2" class="input" placeholder=" 영문, 숫자 8자리 이상"> </span>
							</div>
							<div class="box_inputForm" id="nnpwdDiv">
								<strong>새 비밀번호 확인</strong> <span class="box_label"><input type="password" name="usrPw3" id="usrPw3" class="input" placeholder=" 새 비밀번호를 재입력하세요"> </span>
							</div>
							<span id="cmsg"></span>
						</div>
					</div>
				...
				<div class="btns">
					...
					<button type="button" class="remodal-confirm" id="pass-confimr">비밀번호 변경</button>
				</div>
			</form>
		</div>
		...
		<div class="phonenum_modal_cotents">
			<form name="phonenumForm" method="post" action ="mypage_proc.do">
					...
					<div class="border-box box_withdrawal">
						<div class="inner">
							<div class="box_inputForm" id="phDiv1">
								<strong>비밀번호</strong> <span class="box_label"><input type="password" name="usrPw4" id="usrPw4" class="input" placeholder=" 현재 사이트에 등록된 비밀번호를 입력하세요"> </span>
							</div>
							<div class="box_inputForm" id="phDiv2">
								<strong>휴대폰번호</strong> <span class="box_label"><input type="password" name="usrPw5" id="usrPw5" class="input" placeholder=" 휴대폰번호를 입력하세요"> </span>
							</div>
						</div>
					</div>
				</div>
				<div class="btns">
					...
					<button type="button" class="remodal-confirm" id="phone-confirm">휴대폰번호 변경</button>
				</div>
			</form>
		</div>
	</div>
