...
PdfFont fontTitle = PdfFontFactory.createFont(
		pageContext.getServletContext().getRealPath("/resources/font/NanumBarunGothic.ttf"), "Identity-H", true);
PdfFont fontMain = PdfFontFactory.createFont(
		pageContext.getServletContext().getRealPath("/resources/font/NanumBarunGothic.ttf"), "Identity-H", true);
...
String[] labels = { "카드사", "BC", "카드번호", cardnum, "승인번호", reservnum, "승인일시", rdate, "승인금액", String.valueOf(price),
		"결제금액", String.valueOf(price), };

String[] labels2 = { "출발일 ", deptime, "출발지 ", sstation, "도착지 ", dstation, "출발시간", stime, "일반매수",
		String.valueOf(ticketqty) };
